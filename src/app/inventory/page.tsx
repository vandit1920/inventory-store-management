...
const columns: GridColDef[] =[
    ...
    { field: "rating", headerName: "Rating", width: 100, type: "number", valueGetter: (value, row) => row.rating ? row.rating : "N/A" },
...
const Inventory = () => {
    ...
    <div className="flex flex-col">
        ...
        {/* added the header component in components/header to be used */}
        <DataGrid 
            rows={products}
            columns={columns}
