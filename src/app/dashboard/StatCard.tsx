...
const StatCard = ({
  ...
  return (
    <div className='md:row-span-1 xl:row-span-2 bg-white col-span-1 shadow-md rounded-2xl flex flex-col justify-between'>
        ...
        {/* can specify exact padding values by entering the values in paranthesis */}
        <div className='flex mb-6 items-center justify-around gap-4 px-5'>
            <div className='rounded-full p-5 bg-blue-50 border-sky-300-[1px]'>
                {primaryIcon}
            </div>
                    ...
                    <React.Fragment key={index}>
                        <div className='flex items-center justify-between my-4'>
                            ...
                            <div className='flex item-center'>
                                <detail.IconComponent className={`w-4 h-4 mr-1 ${getChangeColor(
