    ...
    return (
        <Link href={href}>
            ...
            >
                ...
                <span className={`${isCollapsed ? "hidden": "black"
...
const Sidebar = () => {
  ...
  <div className={sidebarClassNames}>
    {/* TOP LOGO */}
    <div className={`flex gap-3 justify-betwwen md:justify-normal items-center pt-8 
  ...
  {/* FOOTER */}
    ...
    <p className="text-center text-xs text-gray-500">&copy; 2024 DeadStcok</p>
    </div>
  </div>
  );
};
